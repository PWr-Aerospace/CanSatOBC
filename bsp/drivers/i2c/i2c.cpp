...
I2C2_setup()
{
  ...
  uint16_t SCLDEL = 999;
  I2C2->TIMINGR = (PRESC << I2C_TIMINGR_PRESC_Pos) | (SCLDEL << I2C_TIMINGR_SCLDEL_Pos) |
...
uint8_t
I2C2_Master_Read(uint8_t slave_addr, uint8_t reg_addr, uint8_t* data, uint16_t len)
{
  uint16_t i;
  ...
  I2C2->CR2 = (slave_addr << I2C_CR2_SADD_Pos) | (1 << I2C_CR2_NBYTES_Pos) | I2C_CR2_START |
  ...
  I2C2->CR2 = (slave_addr << I2C_CR2_SADD_Pos) | (len << I2C_CR2_NBYTES_Pos) | I2C_CR2_START |
              I2C_CR2_RD_WRN;
...
uint8_t
I2C2_Master_Write(uint8_t slave_addr, uint8_t reg_addr, uint8_t* data, uint16_t len)
{
  uint16_t i;
  slave_addr = slave_addr << 1;
