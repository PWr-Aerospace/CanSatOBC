...
extern "C" void __uart4_received_message(uint8_t*);
extern "C" void uart4_receive_to_idle();
...
InterruptVectors& vector = GetInterruptVectorsInstance();

void
UART4_IRQHandler(void)
{
  vector.callback<UART4_IRQn>();
